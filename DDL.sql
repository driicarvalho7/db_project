...
-- TRIGGER 2
-- Garantir que um apoiador não possa ser adicionado em mais de uma equipe que esteja relacionada a candidaturas do mesmo ano. Vamos ajustar o trigger para realizar essa verificação corretamente.
